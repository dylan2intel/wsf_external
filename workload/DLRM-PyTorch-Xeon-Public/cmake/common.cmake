...
add_workload("dlrm_pytorch_xeon_public")
...
add_workload("dlrm_pytorch_xeon_public_training")
foreach (option
                "throughput"
                "accuracy"
        )

        add_testcase(${workload}_${option}_${platform_precision} "${workload}_${option}_${platform_precision}")
endforeach()