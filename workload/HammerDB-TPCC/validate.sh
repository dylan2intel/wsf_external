...
### begin CPU request & limit, DB_CPU_LIMIT will be overwrited by test-config
DB_CPU_LIMIT=${DB_CPU_LIMIT:-4}
### TPCC_THREADS_BUILD_SCHEMA will be set equal to DB_CPU_LIMIT, unless defined by test-config
export TPCC_THREADS_BUILD_SCHEMA=${TPCC_THREADS_BUILD_SCHEMA:-$DB_CPU_LIMIT}
### end
